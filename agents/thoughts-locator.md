...
description: Searches the thoughts/ directory to find and categorize relevant documents — tickets, research, plans, PR descriptions, and notes. Returns organized file locations grouped by type without analyzing contents. The thoughts/ equivalent of codebase-locator.
tools: Grep, Glob, LS
model: sonnet
---
