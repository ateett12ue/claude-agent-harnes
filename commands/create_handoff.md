---
description: Write a structured handoff document capturing tasks, learnings, recent changes, artifacts, and next steps so another agent can resume work in a new session. Saves to thoughts/shared/handoffs/ and syncs.
---
