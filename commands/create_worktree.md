...
---
description: Set up a git worktree for a plan and launch a background humanlayer implementation session that runs /implement_plan, creates a commit, opens a PR, and comments on the Linear ticket.
---
