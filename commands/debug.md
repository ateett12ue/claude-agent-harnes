---
description: Investigate issues during manual testing by examining logs, database state, git history, and service status. Read-only — spawns parallel investigation tasks without editing files.
---
