...
description: Implement smooth page transitions and animations with React's View Transition API — covers the ViewTransition component, shared element morphs, directional navigation slides, enter/exit animations, list reorder, Suspense reveals, transition types, and Next.js integration. Use when adding any route or state-change animation without third-party libraries.
license: MIT
---
