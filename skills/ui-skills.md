...
description: Generate production-grade UI using 60+ documented component patterns and design best practices. Covers layout, interaction, typography, states, and five style presets (modern SaaS, minimal, enterprise, creative, data dashboard). Use when building any web interface — pages, dashboards, forms, navigation, or overlays.
