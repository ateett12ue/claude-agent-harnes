...
description: Visually QA a web application using the built-in browser MCP — navigates pages, takes screenshots, checks console for JS errors, audits network requests for failures, and tests interactive elements. Use after UI changes to verify they render and behave correctly.
---
